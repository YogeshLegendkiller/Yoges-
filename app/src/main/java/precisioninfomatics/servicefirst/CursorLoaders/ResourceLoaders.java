...
public class ResourceLoaders extends CursorLoader {
  private ResourceDAO resourceDAO;
  private Integer id;
    private final ForceLoadContentObserver mObserver = new ForceLoadContentObserver();
    public ResourceLoaders(Context context, Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder,int id) {
