...
/**
 * Created by 4264 on 13/09/2017.
 */

public class VisitSpareData implements GetMethod {
    ...
    public void VisitSpareData(Context context, int incidentID, int visitID, int flag, SwipeRefreshLayout swipeRefreshLayout){
        ...
        try {
         ...
         /*
           ...
           visitModel.setPart(jsonObject.getString("Part"));
            ...
            Log.d("count",String.valueOf(spareDAO.getCount(IncidentID)));
