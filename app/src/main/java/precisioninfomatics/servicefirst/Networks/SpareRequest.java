...
/**
 * Created by 4264 on 30/08/2017.
 */

public class SpareRequest  implements GetMethod {
    private SpareDAO spareDAO;
    private PartIssueDAO partIssueDAO;
    private Integer IncidentID,VisitID;
    private CustomerListDAO customerListDAO;
    private GetJsonObjectResponse getJsonObjectResponse;
    private SerialNumberDAO serialNumberDAO;
    public  SpareRequest(Context context, int incidentID, int visitID){
